...
class TestAddRcDetailsComment extends BuildPipelineTest {
    ...
    void setUp() {
        ...
        binding.setVariable('JENKINS_BASE_URL', "https://build.ci.opensearch.org")
        binding.setVariable('BLUE_OCEAN_URL', "blue/rest/organizations/jenkins/pipelines")
        binding.setVariable('buildJobName', "distribution-build-opensearch")
        binding.setVariable('distributionRcBuildNumber', "10787")
    ...
    void testAddingComment() {
        ...
        assertThat(getCommands('sh', 'comment'), hasItem(containsString("gh issue comment https://github.com/opensearch-project/opensearch-build/issues/5152 --body-file /tmp/workspace/")))
    }
    ...
    void testCommentContent() {
        ...
        assertThat(fileContent, containsString("text=## See OpenSearch RC 5 and OpenSearch-Dashboards RC 5 details"))
