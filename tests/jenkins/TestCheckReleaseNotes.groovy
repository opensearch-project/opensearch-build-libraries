...
class TestCheckReleaseNotes extends BuildPipelineTest {
    ...
    void testNotifyAction() {
        ...
        assertThat(fileContent, allOf(containsString("{file=/tmp/workspace/SSXVNJHPDQ.md, text=Hi, </br>"),
        ...
        assertThat(getCommands('sh', 'opensearch'), hasItem("{script=gh issue comment https://github.com/opensearch-project/opensearch/issues/123 --body-file /tmp/workspace/SSXVNJHPDQ.md, returnStdout=true}"))
