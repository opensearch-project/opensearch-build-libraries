...
class TestCheckDocumentationIssues extends BuildPipelineTest {
    ...
    void setUp() {
        ...
        helper.addShMock("""gh issue list --repo opensearch-project/documentation-website --state open --label v3.0.0 -S "-linked:pr" --json url --jq '.[].url'""") { script ->
            return [stdout: "https://github.com/opensearch-project/documentation-website/issues/22\nhttps://github.com/opensearch-project/documentation-website/issues/23", exitValue: 0]
        }
    ...
    void testNotifyActionWithAssignee(){
        ...
        helper.addShMock("""gh issue view https://github.com/opensearch-project/documentation-website/issues/22 --repo opensearch-project/documentation-website --json assignees --jq '.assignees[0].login'""") { script ->
        ...
        assertThat(getCommands('sh', 'issue'), hasItem("{script=gh issue comment https://github.com/opensearch-project/documentation-website/issues/22 --repo opensearch-project/documentation-website --body-file /tmp/workspace/CCCCCCCCCC.md, returnStdout=true}"))
    ...
    void testCheckAction(){
        ...
        assertThat(getCommands('echo', 'documentation'), hasItem("Open documentation issues found. Issue URLs: [https://github.com/opensearch-project/documentation-website/issues/22, https://github.com/opensearch-project/documentation-website/issues/23]"))
    }
    ...
    void testCheckActionWithNoOpenIssues(){
        ...
        this.registerLibTester(new CheckDocumentationIssuesLibTester('3.0.0', 'check'))
        runScript('tests/jenkins/jobs/CheckDocumentationIssues_Jenkinsfile')
        assertThat(getCommands('echo', 'documentation'), not(hasItem("Open documentation issues found. Issue URLs: [https://github.com/opensearch-project/documentation-website/issues/22, https://github.com/opensearch-project/documentation-website/issues/23]")))
    ...
    void testNotifyActionWithAuthor(){
        ...
        helper.addShMock("""gh issue view https://github.com/opensearch-project/documentation-website/issues/22 --repo opensearch-project/documentation-website --json author --jq '.author.login'""") { script ->
