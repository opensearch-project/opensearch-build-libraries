 ...
 */
void call(Map args = [:]) {
    lib = library(identifier: 'jenkins@9.1.1', retriever: legacySCM(scm))
    ...
    withCredentials([
        ...
        withAWS(role: 'OpenSearchJenkinsAccessRole', roleAccount: "${METRICS_HOST_ACCOUNT}", duration: 900, roleSessionName: 'jenkins-session') {
            ...
            ComponentIntegTestStatus componentIntegTestStatus = new ComponentIntegTestStatus(metricsUrl, awsAccessKey, awsSecretKey, awsSessionToken, version, qualifier, this)
